    ...
    <header className="sticky top-0 z-40 border-b border-line bg-ink/85 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <a href="#" className="hidden text-sm text-fog hover:text-paper sm:block">Sign in</a>
          <button className="rounded-md bg-signal px-5 py-2.5 text-sm font-medium text-ink hover:bg-signal/90">
            Get started
          </button>
        </div>
      </div>
